...
@import '../style/variables';
    ...
    #un:hover , .un:focus svg{
        color: #007ab3;
    }

    #deux:hover , .deux:focus svg{
        color: #f24c12;
    }


    #trois:hover , .trois:focus svg{
        color: #1ad85f;
    }
